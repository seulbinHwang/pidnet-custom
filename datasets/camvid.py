...
class CamVid(BaseDataset):
    ...
    def __init__(self,
        ...
        super(CamVid, self).__init__(ignore_label, base_size, crop_size,
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        image = Image.open(os.path.join(self.root, 'camvid',
                                        item["img"])).convert('RGB')
        image = np.array(image)
        size = image.shape

        color_map = Image.open(os.path.join(self.root, 'camvid',
                                            item["label"])).convert('RGB')
